...
import {
    ChartContainer, PieChart, RowChart, BubbleChart,
    DataTable, DataCount, BarChart, LineChart
} from 'dc-react';
        ...
        return (
            <ChartContainer className="container" crossfilterContext={this.crossfilterContext}>
                ...
                <LineChart
                    ...
                    stack={ctx => [ctx.moveMonthsGroup, 'Monthly Index Move', (d) => {
                        return d.value;
                    }]}
                />
                <DataTable
